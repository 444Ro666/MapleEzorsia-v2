...
void dinput8::CreateHook() {
	...
	else { MessageBox(NULL, L"Failed to load original dinput8.dll from system location, make sure your directory path is not longer than " + MAX_PATH, L"systems directory inaccessible", 0); ExitProcess(0); }
